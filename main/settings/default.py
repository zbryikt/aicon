...
MEDIA_ROOT = '/Users/kirby/workspace/aicon/skeleton-jsblad/media/'
...
STATIC_ROOT = '/Users/kirby/workspace/aicon/skeleton-jsblad/www-static/'
...
filter(lambda x: not x in order_js, vendor_js)
